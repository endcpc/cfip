...
async def main() -> None:
    ...
    for domain, ms in printable:
        ...
        print(f"vless://04c808e2-0b59-47b0-a54b-32fc7ef1c902@{domain}:443?encryption=none&security=tls&sni=misaka.cndyw.ggff.net&fp=random&type=ws&host=misaka.cndyw.ggff.net&path=%2F%3Fed%3D2560#優選|域名|{status}")
